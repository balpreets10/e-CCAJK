package com.mycca.custom.Onboarder;
...
import com.mycca.custom.Onboarder.utils.ColorsArrayBuilder;
import com.mycca.custom.Onboarder.views.CircleIndicatorView;
import com.mycca.R;
...
public abstract class OnboarderActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void setStatusBackgroundColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.colorTransparentBlack));
        }
    }
    ...
    public void onPageSelected(int position) {
        ...
        if (this.shouldUseFloatingActionButton)
            this.fab.setImageResource(position == lastPagePosition ? R.drawable.ic_check_black_24dp : R.drawable.ic_keyboard_arrow_right_black_24dp);
    }
