package com.mycca.custom.Onboarder.views;
...
public class CircleIndicatorView extends View {
    ...
    private void init(Context context) {
        ...
        activeIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.colorWhite));
        ...
        radius = getResources().getDimensionPixelSize(R.dimen.corner_radius_small);
        size = radius * 2;
    }
