package com.mycca.custom.FancyAlertDialog;

/**
 * Created by balpreet on 5/8/2018.
 */
...
public class FancyAlertDialog {
    ...
    private IFancyAlertDialogListener pListener, nListener;
    ...
    public static class Builder {
        ...
        public Builder OnPositiveClicked(IFancyAlertDialogListener pListener) {
            this.pListener = pListener;
            return this;
        }

        //set Negative listener
        public Builder OnNegativeClicked(IFancyAlertDialogListener nListener) {
        ...
        public FancyAlertDialog build() {
            ...
            dialog.setContentView(R.layout.dialog_fancy_alert_layout);
